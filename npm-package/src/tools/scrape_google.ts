...
const GOOGLE_OPERATION_PARAMS_DOC: Record<GoogleOperation, string> = {
  ...
  jobs: "params.q and params.domain; optional params.country, params.hl, params.location, params.start, params.num",
  videos: "params.q and params.domain; optional params.country, params.hl, params.start, params.num",
