...
export const DiscoverParamsSchema = z.object({
    category: z
        ...
        .optional()
        .describe("Optional category filter. One of: 'Content Retrieval', 'Scraping & Verification', 'Proxy', 'Browser & Rendering', 'Health & Discovery', 'Auth'. Omit to list all tools."),
});
 ...
 */
export async function novadaDiscover(params) {
    ...
    lines.push("- **Structured data:** Use `novada_scrape` for 129 platforms (Amazon, TikTok, LinkedIn, etc.).");
