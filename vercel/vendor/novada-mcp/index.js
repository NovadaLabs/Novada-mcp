...
// KR-6: developer-api account-management tools (unified + composables for alias dispatch)
novadaAccount, validateAccountParams, AccountParamsSchema, novadaProxyAccountCreate, validateProxyAccountCreateParams, ProxyAccountCreateParamsSchema, novadaProxyAccountList, validateProxyAccountListParams, ProxyAccountListParamsSchema, novadaIpWhitelist, validateIpWhitelistParams, IpWhitelistParamsSchema, 
            ...
            try {
                ...
                switch (name) {
                    ...
                    case "novada_extract":
                        ...
                        break;
                    case "novada_crawl":
                        result = await novadaCrawl(validateCrawlParams(args), API_KEY, onProgress);
                        break;
                    case "novada_research":
                        result = await novadaResearch(validateResearchParams(args), API_KEY, onProgress);
                        break;
                    case "novada_map":
                    ...
                    // ─── KR-6: developer-api account-management tools ──────────────────
                    case "novada_account":
                        result = await novadaAccount(validateAccountParams(args), API_KEY);
                        break;
                    ...
                    case "novada_wallet_balance":
                        result = await novadaAccount(validateAccountParams({ section: "balance" }), API_KEY);
                        break;
                    case "novada_wallet_usage_record":
                        result = await novadaAccount(validateAccountParams({ ...args, section: "usage" }), API_KEY);
                        break;
                    case "novada_traffic_daily":
                        result = await novadaAccount(validateAccountParams({ ...args, section: "traffic" }), API_KEY);
                        break;
                    case "novada_plan_balance_all":
                        result = await novadaAccount(validateAccountParams({ ...args, section: "plans" }), API_KEY);
                        break;
