...
export const BING_SCRAPER_CONFIG = {
    ...
    description: {
        ...
        operationsNote: "4 verified-working Bing operations: web search, videos, news, and shopping (see the `operation` param's description for the exact `params` keys each needs). Every bing.com catalog operation is currently status:\"ok\" — none are excluded for being backend_broken.",
    },
};
