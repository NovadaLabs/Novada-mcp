...
export const DUCKDUCKGO_SCRAPER_CONFIG = {
    ...
    description: {
        core: "Extract structured DuckDuckGo web search SERP data through a DuckDuckGo-only tool with a closed, typed `operation` enum. Same underlying engine as novada_scrape, pinned to platform=\"duckduckgo.com\". Returns the raw organic-results SERP, with region/time/adult-content filters novada_search does not expose, not a generated answer.",
        useWhen: [
        ...
        operationsNote: "1 verified-working DuckDuckGo operation (web search — see the `operation` param's description for the exact `params` keys it needs). The single duckduckgo.com catalog operation is currently status:\"ok\".",
    },
};
