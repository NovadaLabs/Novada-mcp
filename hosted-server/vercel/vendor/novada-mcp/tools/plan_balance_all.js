...
function isSuspectCaptureZero(raw) {
 ...
 */
async function verifyCaptureZero(apiKey) {
    ...
    try {
        ...
        const reread = await devApiPost(capturePath, {}, { apiKey });
...
const CAPTURE_UNVERIFIED_HUMAN = "0.00 credits — UNVERIFIED (recent capture activity detected; likely a transient balance-read glitch — verify at dashboard.novada.com)";
/**
